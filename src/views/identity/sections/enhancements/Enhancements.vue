...
const { isLoading, data } = BaseQuery()({ endpoint: "body-enhancements" });
</script>

<template>
  <identity-layout v-if="!isLoading" title="Body Enhancements">
    <div class="content_options">
      <base-card-service
        type="square"
        :options="data"
        @change="(value) => nextRoute('body-enhancements', value)"
      />
    </div>
  </identity-layout>
</template>
