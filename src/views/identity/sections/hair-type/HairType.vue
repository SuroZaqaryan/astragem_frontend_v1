...
const { isLoading, data } = BaseQuery()({ endpoint: "hair-type" });
</script>

<template>
  <identity-layout v-if="!isLoading" title="Hair Type">
    <div class="content_options">
      <base-card-service
        type="square"
        :options="data"
        @change="(value) => nextRoute('hair-type', value)"
      />
    </div>
  </identity-layout>
</template>
