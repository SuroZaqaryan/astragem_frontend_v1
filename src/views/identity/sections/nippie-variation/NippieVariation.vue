...
const { isLoading, data } = BaseQuery()({ endpoint: "nippie-variation" });
</script>

<template>
  <identity-layout v-if="!isLoading" title="Find Nipple Variation">
    <div class="content_options">
      <base-card-service
        type="square"
        :options="data"
        @change="(value) => nextRoute('nippie-variation', value)"
      />
    </div>
  </identity-layout>
</template>
